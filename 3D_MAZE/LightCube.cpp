...
void LightCube::Scale(GLfloat scaleX, GLfloat scaleY, GLfloat scaleZ)
{
	ScaleModel = glm::scale(ScaleModel, glm::vec3(scaleX, scaleY, scaleZ));
}

void LightCube::Draw(GLuint uniformLocation)
{
	TransModel = glm::mat4(1.0f);
...
void LightCube::SetModel(GLuint uniformLocation)
{
