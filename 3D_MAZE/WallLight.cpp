...
void WallLight::Apply(Shader& shader)
{
	shader.setvec4("Color", glm::vec4(red+(1-red)*0.3f, green + (1 - green) * 0.3f, blue + (1 - blue) * 0.3f, 0.8f));
	aCube->Draw(shader.GetTransformLocation());
